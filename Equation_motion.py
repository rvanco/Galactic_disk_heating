...
nb_star_bulge = 25
nb_star_disk = 500
nb_star = nb_star_bulge + nb_star_disk


# Setting up list :

list_X, list_Y, list_X_P, list_Y_P, list_R, list_theta, list_Z, list_V_R, list_V_theta, list_V_Z, list_R_P, list_theta_P, list_Z_P, list_V_R_P, list_V_theta_P, list_V_Z_P, list_ang_mom, list_ang_mom_P =  Df.Setting_list(nb_star)   
...
for i in range(nb_star_bulge, nb_star_bulge+nb_star_disk) :
...
Df.XY_GIF(nb_star, list_X, list_X_P, list_Y, list_Y_P, list_Z, G, M_pot, a, b, x_lim, y_lim, dt, t_max, time)
Df.XZ_GIF(nb_star, list_X, list_X_P, list_Y, list_Y_P, list_Z, list_Z_P, G, M_pot, a, b, x_lim, z_lim, dt, t_max, time)
